...
**Do I need to get rid of the N/A??**
...
**By using inner join, I selected to show only the varieties which also were listed with plots. In doing this I likely dropped a few varieties. I could fix this by using full join????????????????**
...
Finally, I would create a new variable -- price_save, by mutating and finding the difference between pricelb_WF and gardenlb_price. This would show how much money was saved for each variety.


  4. Subset the data to tomatoes. Reorder the tomato varieties from smallest to largest first harvest date. Create a barplot of total harvest in pounds for each variety, in the new order.

**cant figure out why it can't find variety, was working before**
